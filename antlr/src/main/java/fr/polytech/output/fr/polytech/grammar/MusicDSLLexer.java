...
public class MusicDSLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FRACTION", "SIGNED_INT", "INT", "VELOCITY_SYMBOL", "INSTRUMENT", "NOTE", 
			"PERCUSSION", "CLIP_NAME", "MAIN_SEQUENCE", "WS", "LINE_COMMENT"
		};
	}
	...
	public MusicDSLLexer(CharStream input) {
		super(input);
